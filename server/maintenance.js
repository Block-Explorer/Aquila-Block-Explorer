...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Aquila Block Explorer</title>
...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://aqxoin.club">
        <img src="https://aqxoin.club/img/stocks/bitcoin.png" title="Aquila Crypto"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>Aquila Block Explorer is not available at this moment.<br/>Please check back later.</p><br/>
  <a href="https://aqxoin.club" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
